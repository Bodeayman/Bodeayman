...
I'm **Abdullah Ayman**, 3rd year **CS** student at [**`ZC`**](https://zewailcity.edu.eg/), **Founding** Software Engineer with strong Fundementals building **Ma3ak** with more than **1K+** Active Users, SWE Intern @ **Fawry** & **ZC**, **ECPC'25** Finalist, **OSS** at **OSGeo** and a Full stack developer. I build scalable web apps, solve algorithmic problems, Interested in **System Design**, **Operating Systems**, **Databases**, **Problem Solving**, **AI Engineering** and Of course **Mathematics**.
